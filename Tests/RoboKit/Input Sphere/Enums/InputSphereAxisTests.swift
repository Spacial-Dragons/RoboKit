...
@Suite("InputEntityAxis")
struct InputEntityAxisTests {
    ...
    func testOrientationValues() {
        ...
        if let lateralOrientation = InputEntityAxis.lateral.orientation {
        ...
        // Vertical: nil
        #expect(InputEntityAxis.vertical.orientation == nil)

        // Longitudinal: rotation -π/2 around X
        if let longitudinalOrientation = InputEntityAxis.longitudinal.orientation {
