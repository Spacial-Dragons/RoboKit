...
struct TCPClientStartConnectionTests {
    ...
    func testStartConnectionWithMessage() async {
        let client = await TCPClient(host: "localhost", port: 1234)
    ...
    func testStartConnectionCallsReadyCallback() async {
        let client = await TCPClient(host: "localhost", port: 1235)
    ...
    func testStartConnectionWithDifferentMessages() async {
        ...
        let client1 = await TCPClient(host: "localhost", port: 1236)
        await client1.startConnection(with: message1)
        await #expect(client1.connection?.stateUpdateHandler != nil)

        let client2 = await TCPClient(host: "localhost", port: 1237)
    ...
    func testStartConnectionPreservesMessageIntegrity() async {
        let client = await TCPClient(host: "localhost", port: 1238)
    ...
    func testStartConnectionStateTransitions() async {
        let client = await TCPClient(host: "localhost", port: 1239)
    ...
    func testStartConnectionFailureStates() async {
        let client = await TCPClient(host: "localhost", port: 1240)
    ...
    func testStartConnectionWithData() async {
        let client = await TCPClient(host: "localhost", port: 1241)
    ...
    func testStartConnectionWithDataCallsReadyCallback() async {
        let client = await TCPClient(host: "localhost", port: 1242)
    ...
    func testStartConnectionWithDifferentDataTypes() async {
        ...
        let client1 = await TCPClient(host: "localhost", port: 1243)
        let stringData = Data("String data".utf8)
        await client1.startConnection(value: stringData)
        await #expect(client1.connection?.stateUpdateHandler != nil)

        // Test with JSON data
        let client2 = await TCPClient(host: "localhost", port: 1244)
        let jsonData = Data("""
        ...
        let client3 = await TCPClient(host: "localhost", port: 1245)
    ...
    func testStartConnectionWithDataPreservesIntegrity() async {
        let client = await TCPClient(host: "localhost", port: 1246)
    ...
    func testStartConnectionWithDataEdgeCases() async {
        ...
        let client1 = await TCPClient(host: "localhost", port: 1247)
        let emptyData = Data()
        await client1.startConnection(value: emptyData)
        await #expect(client1.connection?.stateUpdateHandler != nil)

        // Test with large data
        let client2 = await TCPClient(host: "localhost", port: 1248)
    ...
    func testStartConnectionWithoutData() async {
        let client = await TCPClient(host: "localhost", port: 1249)
    ...
    func testStartConnectionWithoutDataCallsReadyCallback() async {
        let client = await TCPClient(host: "localhost", port: 1250)
        await client.setReadyConnection { }
    ...
    func testStartConnectionVariantsWithSecurity() async {
        ...
        let tlsClient1 = await TCPClient(
            host: "localhost",
            port: 1251,
        ...
        let tlsClient2 = await TCPClient(
            host: "localhost",
            port: 1252,
            security: SecurityOptions(useTLS: true)
        )
        ...
        let tlsClient3 = await TCPClient(
            host: "localhost",
            port: 1253,
            security: SecurityOptions(useTLS: true)
        )
        ...
        let nonTLSClient1 = await TCPClient(
            host: "localhost",
            port: 1254,
        ...
        let nonTLSClient2 = await TCPClient(
            host: "localhost",
            port: 1255,
            security: SecurityOptions(useTLS: false)
        )
        ...
        let nonTLSClient3 = await TCPClient(
            host: "localhost",
            port: 1256,
            security: SecurityOptions(useTLS: false)
        )
    ...
    func testAllStartConnectionVariants() async {
        ...
        let client1 = await TCPClient(host: "localhost", port: 1257)
        await client1.startConnection(with: testMessage)
        await #expect(client1.connection?.stateUpdateHandler != nil)

        let client2 = await TCPClient(host: "localhost", port: 1258)
        await client2.startConnection(value: testData)
        await #expect(client2.connection?.stateUpdateHandler != nil)

        let client3 = await TCPClient(host: "localhost", port: 1259)
